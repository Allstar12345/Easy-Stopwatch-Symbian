...
**
** Created: Mon 14. Sep 20:12:05 2020
...
static const uint qt_meta_data_MediaKeysObserver[] = {
 ...
 // enum data: key, value
      95, uint(MediaKeysObserver::EVolIncKey),
     106, uint(MediaKeysObserver::EVolDecKey),
...
static const char qt_meta_stringdata_MediaKeysObserver[] = {
    ...
    "mediaKeyPressed(int)\0mediaKeyRelease(int)\0"
...
int MediaKeysObserver::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: mediaKeyRelease((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 2
void MediaKeysObserver::mediaKeyRelease(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
